...
public class UndoStorage implements Serializable {
	 ...
	 * 
	 * The checkpoint can later be restored using {@link #restore(com.blaginov.mapparatus.osm.UndoStorage.Checkpoint)}.
	 */
	private class Checkpoint implements Serializable {
		 ...
		 * Called before any changes to the element occur via {@link com.blaginov.mapparatus.osm.UndoStorage#save(OsmElement)}.
		 * @param element the element to save
		 */
	 ...
	 * It is stored in {@link com.blaginov.mapparatus.osm.UndoStorage.Checkpoint}s and used to restore the state of the element on undo.
	 ...
	 * @see com.blaginov.mapparatus.osm.UndoStorage.UndoElement
	 */
