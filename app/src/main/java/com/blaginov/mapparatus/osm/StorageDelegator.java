	...
	public void addNodeToWay(final Node node, final Way way) throws OsmIllegalOperationException {
		...
		try {
			if (way.length() + 1 > Way.MAX_WAY_NODES)
				throw new OsmIllegalOperationException("exception_too_many_nodes");
...
//	}
	...
	/**
	 * Return a localized list of strings describing the changes we would upload on {@link #uploadToServer(ServerS)}.
	 * 
	...
	public void export(OutputStream outputStream) throws Exception {
		...
		serializer.attribute(null, "generator", "Mapparatus");
