...
public class OAuthHelper {
    ...
    public OAuthHelper(SharedPreferences sharedPrefs) throws UnsupportedEncodingException {
        ...
        OAuthHelper.sharedPrefsEditor = sharedPrefs.edit();
    ...
    public void completeOAuthProcess(Uri uri) {
        ...
        if (getVerifier(uri) != null) {
            try {
                ...
                sharedPrefs.edit().putString("accessToken0", accessToken[0]);
                sharedPrefs.edit().putString("accessToken1", accessToken[1]);

                Log.i("accessToken0",accessToken[0]);
                Log.i("accessToken1",accessToken[1]);
